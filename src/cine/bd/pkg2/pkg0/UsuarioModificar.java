...
public class UsuarioModificar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel7.add(tfEmail);
        tfEmail.setBounds(170, 160, 200, 20);
        ...
        jPanel7.add(pfContraseña);
        pfContraseña.setBounds(170, 200, 200, 20);
        ...
        cbNombre.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        ...
        cbNombre.setBounds(170, 80, 200, 20);
    ...
    public void Eliminar() {
        try {
            String Query = "DELETE FROM " + "usuario" + " WHERE Nombre = \"" + cbNombre.getSelectedItem() + "\"";
    ...
    public void MySQLConnection() {
        try {
            ...
            System.out.println("Se ha iniciado la conexión con el servidor de forma exitosa (Usuario - Modificar)");
    ...
    void Seleccion() {
        try {
            ...
            while (resultSet.next()) {
                ...
                if (resultSet.getString(1).equals(cbNombre.getSelectedItem())) {
                    tfApellido.setText(resultSet.getString(2));
                    tfEmail.setText(resultSet.getString(3));
                    pfContraseña.setText(resultSet.getString(4));
