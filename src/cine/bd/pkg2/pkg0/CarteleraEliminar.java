 ...
 * @author Osiel Treto
 */
public class CarteleraEliminar extends javax.swing.JFrame {
    ...
    /**
     * Creates new form CarteleraEliminar
     */
    public CarteleraEliminar() {
        MySQLConnection();
        initComponents();
        getTitulo();
    }
    ...
    private void initComponents() {
        ...
        cbTitulo.setBounds(200, 80, 150, 25);
        ...
        tfGenero.setFont(new java.awt.Font("Calibri", 0, 14)); // NOI18N
...
// TODO add your handling code here:
    ...
    public void EliminarHorarios() {
        try {
            ...
            JOptionPane.showMessageDialog(null, "Error borrando el registro del horario");
        }
    ...
    public void Eliminar() {
        try {
            String Query = "DELETE FROM " + "cartelera" + " WHERE Titulo = \"" + cbTitulo.getSelectedItem() + "\"";
            Statement st = Conexion.createStatement();
            st.executeUpdate(Query);
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                if (resultSet.getString(1).equals(cbTitulo.getSelectedItem())) {
                    tfDirector.setText(resultSet.getString(2));
                    tfAño.setText(resultSet.getString(3));
                    tfClasificacion.setText(resultSet.getString(4));
                    tfDuracion.setText(resultSet.getString(5));
                    tfGenero.setText(resultSet.getString(6));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CarteleraEliminar.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CarteleraEliminar().setVisible(true);
            }
        });
    }
