...
public class UsuarioEliminar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnBorrar.setBackground(new java.awt.Color(162, 28, 38));
        btnBorrar.setFont(new java.awt.Font("Haettenschweiler", 0, 21)); // NOI18N
        ...
        btnBorrar.setBounds(140, 210, 144, 39);
    ...
    private void btnBorrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBorrarActionPerformed
        ...
        dialogButton = JOptionPane.showConfirmDialog(null, "¿Está seguro que desea eliminar a este usuario de forma permanente?\nTenga en cuenta que todos los boletos que haya comprado tambien resultaran afectados");
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        UsuarioRegistrar registrar = new UsuarioRegistrar();
        setVisible(false);
...
public void EliminarBoletos() {
        try {
            String Query = "DELETE FROM " + "venta" + " WHERE Nombre = \"" + cbNombre.getSelectedItem() + "\"";
            Statement st = Conexion.createStatement();
            st.executeUpdate(Query);

        } catch (SQLException ex) {
            System.out.println(ex.getMessage());
            JOptionPane.showMessageDialog(null, "Error borrando el registro de boleto");
        }
    ...
    public void MySQLConnection() {
        try {
            ...
            System.out.println("Se ha iniciado la conexión con el servidor de forma exitosa (Usuario - Eliminar)");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UsuarioEliminar().setVisible(true);
            }
        });
    }
