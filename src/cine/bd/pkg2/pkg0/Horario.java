...
public class Horario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tHorario = new javax.swing.JTable();
        ...
        tHorario.setBackground(new java.awt.Color(51, 51, 51));
        tHorario.setFont(new java.awt.Font("Calibri", 0, 18)); // NOI18N
        tHorario.setForeground(new java.awt.Color(255, 255, 255));
        tHorario.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null},
                {null, null, null},
                {null, null, null},
        ...
        tHorario.setEnabled(false);
        jScrollPane1.setViewportView(tHorario);
        if (tHorario.getColumnModel().getColumnCount() > 0) {
            tHorario.getColumnModel().getColumn(0).setResizable(false);
            tHorario.getColumnModel().getColumn(1).setResizable(false);
            tHorario.getColumnModel().getColumn(2).setResizable(false);
        }
...
// TODO add your handling code here:
    ...
    public void MySQLConnection() {
        try {
            ...
            Conexion = DriverManager.getConnection("jdbc:mysql://localhost:3306/cine", "root", "");
            System.out.println("Se ha iniciado la conexión con el servidor de forma exitosa (Horario)");
    ...
    private javax.swing.JTable tHorario;
