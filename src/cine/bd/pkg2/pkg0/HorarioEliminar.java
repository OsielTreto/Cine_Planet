 ...
 * @author Osiel Treto
 */
public class HorarioEliminar extends javax.swing.JFrame {

    Connection conex = null;
    private static Connection Conexion;

    /**
     * Creates new form HorarioEliminar
     */
    public HorarioEliminar() {
        MySQLConnection();
        initComponents();
        getTitulo();
    }
    ...
    private void initComponents() {
        ...
        jLabel11.setBounds(80, 80, 70, 20);

        jLabel13.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jLabel13.setText("Función");
        jPanel7.add(jLabel13);
        jLabel13.setBounds(80, 120, 90, 20);

        jLabel14.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jLabel14.setText("Sala");
        jPanel7.add(jLabel14);
        jLabel14.setBounds(80, 160, 90, 20);
        ...
        tfFuncion.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        tfFuncion.setEnabled(false);
        jPanel7.add(tfFuncion);
        tfFuncion.setBounds(220, 120, 110, 25);

        tfSala.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        tfSala.setEnabled(false);
        jPanel7.add(tfSala);
        tfSala.setBounds(220, 160, 110, 25);
        ...
        cbTitulo.setBounds(190, 80, 170, 25);

        btnguardar1.setBackground(new java.awt.Color(162, 28, 38));
        btnguardar1.setFont(new java.awt.Font("Haettenschweiler", 0, 21)); // NOI18N
        ...
        btnguardar1.setBounds(140, 240, 144, 39);
...
// TODO add your handling code here:
    ...
    private void btnguardar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnguardar1ActionPerformed
        ...
        dialogButton = JOptionPane.showConfirmDialog(null, "¿Está seguro que desea eliminar esta pelicula de forma permanente?");
    ...
    public void MySQLConnection() {
        try {
            ...
            System.out.println("Se ha iniciado la conexión con el servidor de forma exitosa (Horario - Eliminar)");
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                if (resultSet.getString(1).equals(cbTitulo.getSelectedItem())) {
                    tfFuncion.setText(resultSet.getString(2));
                    tfSala.setText(resultSet.getString(3));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HorarioEliminar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HorarioEliminar().setVisible(true);
            }
        });
    }
