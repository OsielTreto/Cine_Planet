 ...
 * @author Osiel Treto
 */
public class HorarioRegistrar extends javax.swing.JFrame {

    Connection conex = null;
    private static Connection Conexion;

    /**
     * Creates new form HorarioRegistrar
     */
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        HorarioModificar modificar = new HorarioModificar();
        setVisible(false);
...
// TODO add your handling code here:
    ...
    public void MySQLConnection() {
        try {
            ...
            System.out.println("Se ha iniciado la conexión con el servidor de forma exitosa (Horario - Registrar)");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HorarioRegistrar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HorarioRegistrar().setVisible(true);
            }
        });
    }
